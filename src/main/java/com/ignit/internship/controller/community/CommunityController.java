...
public class CommunityController {
    ...
    @PostMapping
    public ResponseEntity<DefaultResponse<CommunityResponse>> createCommunity(CommunityRequest request) throws IdNotFoundException {
    ...
    public ResponseEntity<DefaultResponse<CommunityResponse>> getCommunity(@PathVariable Long id) throws IdNotFoundException {
        return ResponseReturn.ok(new CommunityResponse(communityService.getCommunityById(id)));
    }
}
